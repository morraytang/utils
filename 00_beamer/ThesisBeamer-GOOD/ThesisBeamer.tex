...
%\setlength\fboxrule{2pt}\setlength\fboxsep{0mm}
  ...
  \begin{tikzpicture}%[overlay]
    \node[draw=orange,inner sep=.1mm]
      (fan) at (0,0) {\includegraphics[width=0.5cm]{fan.jpg}};
